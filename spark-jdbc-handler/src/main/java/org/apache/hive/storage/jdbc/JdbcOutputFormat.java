...
import org.apache.hive.storage.jdbc.write.MyHiveRecordWriter;
...
public class JdbcOutputFormat implements OutputFormat<NullWritable, MapWritable>,
    ...
    private static final String DBCP_CONFIG_PREFIX = JdbcStorageConfigManager.CONFIG_PREFIX + ".dbcp";
    ...
    public RecordWriter getHiveRecordWriter(JobConf jc,
        ...
        Configuration tableConfig = JdbcStorageConfigManager.convertPropertiesToConfiguration(tableProperties);

        DatabaseAccessor dbAccessor = DatabaseAccessorFactory.getAccessor(tableConfig);


        return new MyHiveRecordWriter(dbAccessor,tableConfig);
    }
